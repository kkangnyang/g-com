...
export default function ChatRoom() {
    ...
    const messages = [
        { messageId: 1, roomId: 123, id: 'gayoung', content: '안녕하세요.', createdAt: new Date() },
        { messageId: 2, roomId: 123, id: 'nayoung', content: '안녕히가세요.', createdAt: new Date() },
    ]
    return (
